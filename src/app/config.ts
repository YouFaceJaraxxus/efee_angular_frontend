export const constants = {
    ...
    SHARE_LINK : "http://localhost:4200/oglas/"
};
...
export const util = {
    ...
    formatAnnouncementDate:(date:string, language:string)=>{
        if(date){
            ...
            let newDateString = dateStringSplit[2]+". " + util.mapMonth(dateStringSplit[1]);
    ...
    transliterate : (text, direction) =>{
        if(text!=null){
          var cyrillic = 'А_Б_В_Г_Д_Ђ_Е_Ж_З_И_Ј_К_Л_Љ_М_Н_Њ_О_П_Р_С_Т_Ћ_У_Ф_Х_Ц_Ч_Џ_Ш_а_б_в_г_д_ђ_е_ж_з_и_ј_к_л_љ_м_н_њ_о_п_р_с_т_ћ_у_ф_х_ц_ч_џ_ш_Њ_Џ_Љ'.split('_')
        var latin = 'A_B_V_G_D_Đ_E_Ž_Z_I_J_K_L_Lj_M_N_Nj_O_P_R_S_T_Ć_U_F_H_C_Č_Dž_Š_a_b_v_g_d_đ_e_ž_z_i_j_k_l_lj_m_n_nj_o_p_r_s_t_ć_u_f_h_c_č_dž_š_NJ_DŽ_LJ'.split('_')
...
const getZavrsniRadoviFilterString = (where, orderBy, fetchSize, fetchOffset) =>{
  ...
  let queryEncoded = encodeURIComponent(encodeURIComponent(JSON.stringify(query)));
  return queryEncoded;
}
